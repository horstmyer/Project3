...
##Images are provided by developer.  Application was created via Laravel.  Included in the application are Laravel (including default packages) as well as fzaninotto/Faker. Additional tools include Debugbar and logs. ##